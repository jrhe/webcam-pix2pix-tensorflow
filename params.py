...
params_list = [
    {'name': 'Main', 'type': 'group', 'children': [
        ...
        {'name': 'sleep_s', 'type': 'float',
            'value': 0.001, 'limits': (0, 10)},
    ]},
    {'name': 'Save', 'type': 'group', 'children': [
        {'name': 'take_snapshot', 'type': 'bool', 'value': False},
        {'name': 'save_continuously', 'type': 'bool', 'value': False},
        {'name': 'Frames', 'type': 'group', 'children': [
            {'name': 'capture', 'type': 'bool', 'value': False},
            {'name': 'processed', 'type': 'bool', 'value': False},
            {'name': 'prediction', 'type': 'bool', 'value': True}
        ]},
        {'name': 'filename_template', 'type': 'str',
            'value': "./output/{timestamp}_{frame_type}.png"}
    ]},
    {'name': 'Capture', 'type': 'group', 'children': [
        ...
        {'name': 'Init', 'type': 'group', 'children': [
            ...
            {'name': 'device_id', 'type': 'int', 'value': 1},
        ...
        {'name': 'Processing', 'type': 'group', 'children': [
            ...
            {'name': 'adaptive_thresh_block', 'type': 'int',
            ...
            {'name': 'accum_w1', 'type': 'float',
                'limits': (0, 1), 'value': 0, 'step': 0.1},
            {'name': 'accum_w2', 'type': 'float',
                'limits': (0, 1), 'value': 0, 'step': 0.1},
    ...
    {'name': 'Prediction', 'type': 'group', 'children': [
        {'name': 'enabled', 'type': 'bool', 'value': True},
        {'name': 'pre_time_lerp', 'type': 'float',
            'limits': (0, 1), 'value': 0, 'step': 0.1},
        {'name': 'post_time_lerp', 'type': 'float',
            'limits': (0, 1), 'value': 0.5, 'step': 0.1},
    ]},
